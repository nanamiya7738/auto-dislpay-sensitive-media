      ...
      this.createMenuItem(
        ...
        () => {
          ...
          window.localStorage.setItem(
            `ADSM_${this.timelineData.timelineTitle1}_${this.timelineData.timelineTitle2}_setAutoDisplaySensitiveMedia`,
      ...
      this.createMenuItem(
        ...
        () => {
          this.timelineData.setFilterIncludeMedia =
            !this.timelineData.setFilterIncludeMedia
          window.localStorage.setItem(
            `ADSM_${this.timelineData.timelineTitle1}_${this.timelineData.timelineTitle2}_setFilterIncludeMedia`,
