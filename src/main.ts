...
window.addEventListener("load", () => {
  util.consoleLog("main strat......")

  util.startProcessAfterCreateElement(
    () => document.querySelectorAll<HTMLElement>(querySelector.quaryDeckButton),
    () => {
      document
        .querySelectorAll<HTMLElement>(querySelector.quaryDeckButton)
        .forEach((button) => {
